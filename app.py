...
def upload_sticker():
    """Upload a transparent PNG/SVG/WEBP/GIF for the global sticker library.
    DMs always allowed; players allowed only if any session they're in has
    players_can_use_stickers=True. Returns the URL for the client."""
    ...
    if not is_dm_somewhere:
        ...
        for code, _entry in sessions_map.items():
            sess = sessions.get(code)
            if sess and sess.get("players_can_use_stickers", True):
                allowed = True
                break
        if not allowed:
...
def on_set_players_can_use_stickers(data):
    info = socket_info.get(request.sid)
    if not info or info["role"] != "dm":
        return
    code = info["code"]
...
FORTUNES = [
    ...
    "Any decision you make today will be the right one.",
    ...
    "Bleakness of winter is as fruitful as summer abundance.",
    "By swallowing evil words unsaid, no one has ever harmed his stomach.",
    "Change is happening in your life, so go with the flow!",
    "Congratulations! You are on your way.",
    "Curiosity kills boredom. Nothing can kill curiosity.",
    "Dedicate yourself with a calm mind to the task at hand.",
    "Difficult problems are best solved in groups.",
    "Do not be intimidated by the eloquence of others.",
    "Do not let ambition get in the way of friendship.",
    ...
    "Festivity is in the air around you.",
    "Find release from your cares, have a good time.",
    "Fortune favors the bold.",
    "From listening comes wisdom, and from speaking repentance.",
    "Go for the gold today! You'll be glad you did.",
    ...
    "Ignore previous fortune. Roll 1d20.",
    ...
    "Like the river, time flows swiftly and does not return.",
    ...
    "New and rewarding opportunities will soon develop.",
    "Nothing is impossible to a willing heart.",
    "Now is the time to try something new.",
    "One who admires you greatly is hidden before your eyes.",
    "Opportunity awaits you next Thursday.",
    "Others can help you now.",
    "Our greatest glory is not in never falling but in rising every time we fall.",
    "Patience is a virtue — so is getting out of the way.",
    "Persistence and patience reward you in time.",
    "Practicing kindness is not naive — it is powerful.",
    ...
    "Right now is the time to start planning for your future goals.",
    "Roll for initiative.",
    "Romance moves you in a new direction.",
    "Say you're sorry when you hurt someone.",
    "Share your happiness with those around you.",
    "Smiling often can make you feel better.",
    ...
    "You have a natural grace and a great deal of consideration for others.",
    "You have a yearning for perfection.",
    "You have an active mind and a keen imagination.",
    "You learn from your mistakes. You will learn a lot today.",
    "You will always be surrounded by true friends.",
    "You will be a great success both in business and society.",
    ...
    "Your heart is pure, and your mind is clear, and your soul devout.",
...
@socketio.on("fortune_cookie")
def on_fortune_cookie():
    info = socket_info.get(request.sid)
    if not info:
        return
    code = info["code"]
